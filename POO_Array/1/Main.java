public class Main{
  public static void main(String args[]){
    ...
    Produto p1 = new Produto(1, "Refrigerante", 3.90f, 10);
    Produto p2 = new Produto(2, "Batata Palha", 6.20f, 20);
    Produto p3 = new Produto(3, "Lasanha 600g", 11.2f, 30);
    Produto p4 = new Produto(4, "Picanha", 100000.99f, 40);
